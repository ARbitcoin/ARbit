...
// ARbit: total coins staked (non-spendable until maturity)
...
// ARbit: get current stake weight
...
// ARbit: check 'spent' consistency between wallet and txindex
// ARbit: fix wallet spent state according to txindex
...
// ARbit: disable transaction (only for coinstake)
